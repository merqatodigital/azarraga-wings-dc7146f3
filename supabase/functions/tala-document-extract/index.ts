...
Amounts are integer centavos. Preserve exact raw descriptions and raw dimensions. Normalize dimensions to millimeters only when clearly stated. Preserve opening codes. Separate VAT, crating, shipping, trucking, delivery, installation and discounts from product lines. Unreadable fields are null and listed in missingInformation. Ambiguity requires humanReviewRequired=true. A customer's PO to Azarraga is purchase_order, never an Azarraga invoice.`;
